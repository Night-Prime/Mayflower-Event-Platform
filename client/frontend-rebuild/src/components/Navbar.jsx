...
export const Navbar = ({ booking }) => {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="sticky top-0 z-50 w-full h-20 xl:h-28 xl:py-2 bg-transparent m-0 xl:my-2"
    >
      <motion.div className="bg-mayblack rounded-b-2xl xl:rounded-2xl w-[100%] xl:w-[96%] h-full flex justify-between items-center mx-auto px-6">
        <motion.p
        ...
        >
          <RouterLink to="/">
            <motion.img
              ...
              alt="Main Logo"
              className="w-[20%] 2xl:w-[7.5%] object-contain"
            />
          </RouterLink>
        </motion.p>
        ...
        <motion.div
          ...
          } transition-transform duration-300 ease-in-out xl:static xl:w-auto xl:flex xl:transform-none z-40`}
        >
          <motion.ul
            variants={containerVariants}
