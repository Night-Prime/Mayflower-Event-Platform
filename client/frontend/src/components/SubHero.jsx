...
const SubHero = () => {
  ...
  return (
    <motion.div className="w-full h-auto 3xl:h-screen">
      <motion.div
        {...childReveal}
        className="w-full h-5/6 px-5 mt-[10%] flex flex-col  items-start  justify-start "
      >
        <motion.h1 className="font-Cinzel text-[20px] 3xl:text-6xl text-mayblack">
          THE{" "}
        ...
        <motion.div className="flex flex-col xl:flex-row justify-between gap-8">
          ...
          <motion.div className="flex-1 flex flex-col items-start justify-start xl:gap-6">
            <motion.h1 className="mt-6 text-mayblack font-Cinzel text-[16px] 3xl:text-6xl 3xl:mt-12">
              MAY GARDEN <br />{" "}
              <motion.span className="text-gardenslight">
                LOVE STORY
              </motion.span>
            </motion.h1>
            <motion.p className="w-[90%] font-normal text-mayblack text-justify text-[12px] 3xl:text-3xl">
