...
export const Hero = () => {
  return (
    <div className="font-Playfair flex flex-col gap-4 w-full items-center justify-center sm:mt-[150px] lg:mt-[200px] px-4">
      ...
      <button className="bg-transparent border-[2px] border-[#cc5500] text-[#cc5500] py-[12px] px-[20px] sm:py-[14px] sm:px-[22px] lg:py-[16px] lg:px-[24px] rounded-lg text-[16px] sm:text-[18px] lg:text-[20px] font-bold font-Inter w-[160px] sm:w-[180px] lg:w-[222px] mt-6 sm:mt-8 lg:mt-10">
        Book a tour
      </button>
      </div>
